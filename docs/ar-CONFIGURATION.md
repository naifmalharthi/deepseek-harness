...
| تبويب الإعدادات | الشاشة |
|------------------|-------|
| **الإعدادات العامة** — اللغة، المظهر، الخط | ![](ar-settings-general.png) |
| **النماذج** — مزوّدات API + النماذج المخصّصة | ![](ar-settings-models.png) |
| **إعدادات الوكيل المسبقة** — standard / ptc / minimal / cordis | ![](ar-settings-agent.png) |
| **الإضافات** — تفعيل/تعطيل الإضافات المبنية | ![](ar-settings-plugins.png) |
